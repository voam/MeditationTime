 ...
 *  MeDitationTime
 *
 *  Journey_level_7.class: Controller class for level seven of the journey section
 *
 *  @version    1.0
...
public class Journey_level_7 extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                new CountDownTimer(remaining, 1000) { // adjust the milli seconds here
                    ...
                    public void onTick(long millisUntilFinished) {
                        ...
                        waveView.setProgress((int)((198-(millisUntilFinished / 1000))*(100/198.0)));
