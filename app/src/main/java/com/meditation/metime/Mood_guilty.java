 ...
 *  MeDitationTime
 *
 *  Mood_guilty.class: Controller class for a specific mood of the mood section
 *
...
public class Mood_guilty extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mood_guilty);
        ...
        Mp= MediaPlayer.create(this, R.raw.guilt);
            ...
            public void onClick(View v) {
                ...
                new CountDownTimer(remaining, 1000) { // adjust the milli seconds here
                    ...
                    public void onTick(long millisUntilFinished) {
                        ...
                        waveView.setProgress((int)((209-(millisUntilFinished / 1000))*(100/209.0)));
