 ...
 *  MeDitationTime
 *
 *  Mood_impatient.class: Controller class for a specific mood of the mood section
 *
...
public class Mood_impatient extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mood_impatient);
        ...
        Mp= MediaPlayer.create(this, R.raw.impatients);
            ...
            public void onClick(View v) {
                ...
                new CountDownTimer(remaining, 1000) { // adjust the milli seconds here
                    ...
                    public void onTick(long millisUntilFinished) {
                        ...
                        waveView.setProgress((int)((230-(millisUntilFinished / 1000))*(100/230.0)));
