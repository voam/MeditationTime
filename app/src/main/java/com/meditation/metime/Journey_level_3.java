 ...
 *  MeDitationTime
 *
 *  Journey_level_3.class: Controller class for level three of the journey section
 *
...
public class Journey_level_3 extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                new CountDownTimer(remaining, 1000) { // adjust the milli seconds here
                    ...
                    public void onTick(long millisUntilFinished) {
                        ...
                        waveView.setProgress((int)((89-(millisUntilFinished / 1000))*(100/89.0)));
