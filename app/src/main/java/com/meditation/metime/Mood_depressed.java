 ...
 *  MeDitationTime
 *
 *  Mood_depressed.class: Controller class for a specific mood of the mood section
 *
...
public class Mood_depressed extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mood_depressed);
        ...
        Mp= MediaPlayer.create(this, R.raw.depression);
            ...
            public void onClick(View v) {
                ...
                new CountDownTimer(remaining, 1000) { // adjust the milli seconds here
                    ...
                    public void onTick(long millisUntilFinished) {
                        ...
                        waveView.setProgress((int)((250-(millisUntilFinished / 1000))*(100/250.0)));
