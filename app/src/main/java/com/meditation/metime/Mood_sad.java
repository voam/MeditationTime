 ...
 *  MeDitationTime
 *
 *  Mood_sad.class: Controller class for a specific mood of the mood section
 *
 *  @version    1.0
...
public class Mood_sad extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mood_sad);
        ...
        Mp= MediaPlayer.create(this, R.raw.sadness);
            ...
            public void onClick(View v) {
                ...
                new CountDownTimer(remaining, 1000) { // adjust the milli seconds here
                    ...
                    public void onTick(long millisUntilFinished) {
                        ...
                        waveView.setProgress((int)((265-(millisUntilFinished / 1000))*(100/265.0)));
